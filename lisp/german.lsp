...
;; Weitere Einzelheiten zu den Benutzerrechten unter Lizenzrechte. 
 ...
 (setq max_error       "Max Spielerzahl sollte gleich oder mehr als Min Spielerzahl sein ") ; V-C changed
	 ...
	 (setq thank_you "Danke, da· Sie Abuse spielten!\n\n")     ; V-A
        ...
        ('upgrade_section
         (setq enter_old_dir   "In das Verzeichnis der Ñlteren registrierten Version von ABUSE gehen.")
         (setq dir_not_here    "Verzeichnis existiert nicht : ")
         (setq already_updated "Diese ABUSE-Version ist bereits auf dem neuesten Stand.")
         (setq updating        "Dateien-Update, bitte warten.")
         (setq yes-key         "J")
         (setq no-key          "N")
         (setq complete_title  "Neue Shareware Version wurde aufgerÅstet.")
         (setq remove_old_reg  "Alte registrierte Version lîschen? (J/N)")))
